...
import { HiOutlineExclamationCircle, HiOutlineLocationMarker, HiOutlineCalendar, HiOutlineRefresh } from 'react-icons/hi';
                                        ...
                                        <div className="space-y-5 flex-1 flex flex-col justify-start">
                                            ...
                                            <div className="text-center space-y-4">
                                                ...
                                                <div className="flex items-center justify-center gap-3">
                                                    ...
                                                    <span className="text-xl md:text-2xl font-bold text-red-200">Error en el Pago</span>
                                                </div>
                                            ...
                                            <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md rounded-2xl p-5 border border-white/15">
                                                <h3 className="text-lg font-bold mb-4 text-center">No te preocupes</h3>
                                                <div className="space-y-3">
                                                    <div className="text-center">
                                                        <div className="text-lg font-bold text-blue-300">Podés intentar nuevamente</div>
                                                        <div className="text-sm text-orange-200 font-medium">Aún hay tiempo para inscribirte</div>
                                                    </div>
                                                </div>
                                                <p className="text-center text-xs text-blue-200/80 mt-3">El 10K del Maestro te está esperando</p>
                                            </div>
                                        </div>
                                            ...
                                            <div className="space-y-6 text-center">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-gray-600 mb-4">
                                                        Lamentablemente, no pudimos completar tu pago para el 10K del Maestro.
                                                    </p>
                                                    <p className="text-gray-600 mb-6">
                                                        Te invitamos a intentarlo nuevamente. Si el problema continúa, contactá nuestro equipo de soporte.
                                                    </p>
                                                </div>

                                                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                                                    <div className="flex items-center justify-center text-red-800 mb-3">
                                                ...
                                                <div className="text-center text-sm text-gray-500">
                                                    Para asistencia, por favor <a href="https://instagram.com/codeo.ar" target="_blank" rel="noopener noreferrer" className="text-red-500 hover:text-red-700 underline">contáctanos en Instagram</a>.
                                                </div>
                                            </div>
                                        </div>
                                    </Card>
